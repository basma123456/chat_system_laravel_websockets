                        ...
                        <div class="text-success" id="div-data"></div>
                            ...
                            <input type="hidden" id="receiver_id" value="{{$id}}" />
                                ...
                                <input type="hidden" id="user_id" value="{{auth()->id()}}" />
                                    <input type="text" class="d-block form-control w-75 text-center message" name="message" id="message_input" value="" placeholder="write a message ...." />
                                
                                    <button type="submit" onclick="getMyMessage()" id="message_sent">Send Message</button>
                            </div>
...
<script>
window.Echo.channel("public_channel").listen(".notification" , (e)=>{
    console.log(e);
