...
///////private///////////
Route::get('/get_page_private/{id}', [NotificationController::class , 'getNotificationPagePrivate'])->middleware(['auth']);
...
Route::get('/my_profile' ,[NotificationController::class , 'getMyProfile'])->middleware(['auth']);
Route::get('/get_users' ,[NotificationController::class , 'getAllUsers'])->middleware(['auth']);
Route::put('users/{id}' , [MyProfileController::class , 'update']);
Route::post('change_photo/{id}' , [MyProfileController::class , 'changeProfilePhoto'])->name('change.profile.photo')->middleware(['auth']);
